...
proc proc_listcommands { nick uhost hand chan } {
  ...
  if {[matchattr $hand o|o $chan]} {
    ...
    putserv "NOTICE $nick :!opme - Se Opper"
    putserv "NOTICE $nick :!deopme - Se Dé-opper"
    putserv "NOTICE $nick :!op <nickname> - Opper une personne"
    putserv "NOTICE $nick :!deop <nickname> - Dé-opper une personne"
    putserv "NOTICE $nick :!whois <nickname> - Trouver quelqu'un dans la base d'utilisateur du bot"
    putserv "NOTICE $nick :!kick <nickname> - Expulser une personne"
    putserv "NOTICE $nick :!ban <nickname> - Bannir une personne"
    putserv "NOTICE $nick :!server - Dire le serveur de connection du bot"
    putserv "NOTICE $nick :!lc - Bloquer le channel lors d'une attaque de flood"
    putserv "NOTICE $nick :!uc - Débloquer le channel"
  ...
  if {[matchattr $hand m|m $chan]} {
    ...
    putserv "NOTICE $nick :!addop <nickname> - Ajouter un pseudo à la liste Auto-Op du bot"
    putserv "NOTICE $nick :!delop <nickname> - Enlever un pseudo à la liste Auto-Op du bot"
    ...
    putserv "NOTICE $nick :!jump <server> - Force le bot à changer de serveur"
