...
#   if {![catch {eof $sock} eof] && $eof} {}
		if { ([lsearch -exact [file channels] $sock] != -1) && (![catch {eof $sock} eof]) && $eof } {
# @@@@@@@@@@@@@@@@@@@@@@
...
#    {} elseif {[catch {eof $sock} iseof] || $iseof} {}
		} elseif { ([lsearch -exact [chan channels] $sock] == -1) || ([catch {eof $sock} iseof]) || $iseof } {
# @@@@@@@@@@@@@@@@@@@@@@
